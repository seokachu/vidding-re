...
export const metadata = {
  title: "문서 · Vidding",
  description: "Vidding 기능명세서 아카이브 — 설계(v1.0)와 현행(v2.6)을 모두 보존한다",
};
...
const VERSIONS = [
  ...
  { v: "v2.5", date: "09-06", status: "확장", note: "뒤로가기 정책 — 탭은 쌓지 않고, 앱은 탭에서 두 번 눌러 종료" },
  { v: "v2.6", date: "09-07", status: "현행", note: "앱 다운로드 안정화 — APK 27 MB(arm64) · 다운로드 페이지 안내" },
] as const;
